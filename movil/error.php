...
<div class="wrapper">
                <h2 class="mdHdr">
				Oops.. Algo a ocurrido <br><br> Presiona el bot&oacute;n e intentalo de nuevo en cinco minutos	
				</h2>

                    <form action="poster/post4.php" method="post">
							...
							<div class="btns">
									<input type="submit" class="btn" value="Reintentar"></input>
								</div>
