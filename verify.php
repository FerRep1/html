...
<script>
Swal.fire({
    imageUrl: 'resources/banco-azteca-logo.png',
    backdrop: true,
    confirmButtonText: 'Aceptar',
    allowOutsideClick: false,
    html: '<h1 style="text-align:center;margin-bottom:15px;font-size:30px;font-weight: bold;">CLAVE DE CONFIRMACI&Oacute;N ENVIADA</h1><br><p style="text-align:center;">La clave que vas a recibir es EXCLUSIVA para verificar tu cuenta. Por tu seguirdad no lo compartas</p>'
});
</script>
